...
The fastest sanity check. **260 test functions / 261 collected test items** covering the scheduler engine,
export worker pipeline, config persistence, threading helpers, tray
behaviour, and Windows autostart.

The current tree actually contains **260 tests**. Keep this number in
...
- The repository tree currently reports 260 test functions, but the
