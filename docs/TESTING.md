...
The fastest sanity check. **254 test functions / 255 collected test items** covering the scheduler engine,
export worker pipeline, config persistence, threading helpers, tray
behaviour, and Windows autostart.

The current tree actually contains **254 tests**. Keep this number in
...
- The repository tree currently reports 254 test functions, but the
