...
The fastest sanity check. **213 test functions / 214 collected test items** covering the scheduler engine,
export worker pipeline, config persistence, threading helpers, tray
behaviour, and Windows autostart.

The current tree actually contains **213 tests**. Keep this number in
...
- The repository tree currently reports 213 test functions, but the
