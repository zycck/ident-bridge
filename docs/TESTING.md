...
The fastest sanity check. **215 test functions / 216 collected test items** covering the scheduler engine,
export worker pipeline, config persistence, threading helpers, tray
behaviour, and Windows autostart.

The current tree actually contains **215 tests**. Keep this number in
...
- The repository tree currently reports 215 test functions, but the
