...
The fastest sanity check. **221 test functions / 222 collected test items** covering the scheduler engine,
export worker pipeline, config persistence, threading helpers, tray
behaviour, and Windows autostart.

The current tree actually contains **221 tests**. Keep this number in
...
- The repository tree currently reports 221 test functions, but the
