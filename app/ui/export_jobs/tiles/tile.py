...
from app.ui.widgets import BusyPushButton, style_menu_popup

_RUNTIME_STATUS_COLORS: dict[str, str] = {
    "idle": Theme.gray_500,
    "ok": Theme.success,
    "error": Theme.error,
    "running": Theme.info,
...
class ExportJobTile(QFrame):
    ...
    def __init__(self, job: ExportJob, parent: QWidget | None = None) -> None:
        ...
        self._runtime_status_text: str | None = None
        self._running = False
        self._build_ui()
    ...
    def _build_ui(self) -> None:
        ...
        self._run_btn = BusyPushButton("", self, busy_color=Theme.primary_700)
        self._run_btn.setIcon(lucide("play", color=Theme.gray_900, size=12))
        self._run_btn.setIconSize(QSize(12, 12))
        self._run_btn.setObjectName("primaryBtn")
        self._run_btn.setFixedSize(28, 28)
        self._run_btn.capture_idle_state()
    ...
    def update_from_job(self, job: ExportJob) -> None:
        ...
        if not self._running:
            self._runtime_status_text = None
            self._apply_status_style(display.status_text, display.status_color)
    ...
    def set_runtime_state(self, *, kind: str, text: str, running: bool) -> None:
        ...
        self._run_btn.set_busy(running)
        self._run_btn.setEnabled(not running)
        self._apply_status_style(
            text,
            _RUNTIME_STATUS_COLORS.get(kind, Theme.gray_500),
        )
    ...
    def clear_runtime_state(self) -> None:
        ...
        self.update_from_job(self._job)
    ...
    def _apply_status_style(self, text: str, color: str) -> None:
