...
from PySide6.QtCore import QEvent, QObject, QRegularExpression, QSignalBlocker, QSortFilterProxyModel, QSize, QStringListModel, QTimer, Qt, Signal, Slot
...
from app.ui.widgets import BusyPushButton, HeaderLabel, style_combo_popup
...
class ExportGoogleSheetsPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._refresh_btn = BusyPushButton("Обновить", self, busy_text="Обновить")
        self._refresh_btn.setIconSize(QSize(12, 12))
        self._refresh_btn.capture_idle_state()
