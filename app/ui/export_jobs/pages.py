...
from app.ui.widgets import apply_light_window_palette, hsep
...
class ExportJobsTilesPage(QWidget):
    ...
    def _build_ui(self) -> None:
        self.setObjectName("exportJobsTilesPage")
        self.setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
        self.setStyleSheet(
            f"QWidget#exportJobsTilesPage {{ background-color: {Theme.surface_tinted}; }}"
        )
        ...
        self._grid_container.setStyleSheet(f"background: {Theme.surface_tinted};")
...
class ExportJobsEditorPage(QWidget):
    ...
    def _build_ui(self) -> None:
        self.setObjectName("exportJobsEditorPage")
        self.setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
        self.setStyleSheet(
            f"QWidget#exportJobsEditorPage {{ background-color: {Theme.surface_tinted}; }}"
        )
        layout = QVBoxLayout(self)
        layout.setContentsMargins(0, 0, 0, 0)
        layout.setSpacing(0)
