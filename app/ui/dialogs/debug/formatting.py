...
_STYLE_DEFAULT = Theme.gray_900
_STYLE_TIMESTAMP = Theme.gray_500
_STYLE_LOGGER = Theme.primary_700
_LEVEL_COLORS: dict[str, str] = {
    "DEBUG": Theme.gray_500,
    "INFO": Theme.info,
...
def format_log_line_html(text: str) -> str:
    ...
    level_color = _LEVEL_COLORS.get(level, Theme.gray_400)
