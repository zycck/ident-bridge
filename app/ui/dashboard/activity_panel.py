...
from app.ui.dashboard_activity import clear_job_histories, refresh_dashboard_activity, refresh_dashboard_activity_entries
...
class DashboardActivityPanel(QFrame):
    ...
    def refresh_activity(self) -> None:
        ...
        if entries:
            count = refresh_dashboard_activity_entries(self._activity_layout, self, entries)
        else:
            count = refresh_dashboard_activity(self._activity_layout, self, load_export_jobs(self._config))
